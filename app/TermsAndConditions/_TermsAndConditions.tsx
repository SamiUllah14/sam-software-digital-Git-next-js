  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <ul>
        ...
        <li>Avoid exploiting, abusing, or interfering with our services.</li>
      </ul>

      <h2>4. Intellectual Property</h2>
      <p>
        All content, materials, and intellectual property rights in our
        services are owned by NewYorkSoftwares.com. You may not use our
      ...
      <p>
        To the maximum extent permitted by law, NewYorkSoftwares.com shall not
